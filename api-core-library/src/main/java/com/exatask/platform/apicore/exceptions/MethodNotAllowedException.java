...
public class MethodNotAllowedException extends HttpException {
  ...
  protected MethodNotAllowedException(String message) {
    super(message);
  }
  ...
  public static HttpException buildException(
    ...
    return HttpException.buildException(
        HttpStatus.METHOD_NOT_ALLOWED, message, appError, errorArguments, exception, invalidAttributes,extraParams);
  }
}
