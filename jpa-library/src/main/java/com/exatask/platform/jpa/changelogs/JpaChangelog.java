package com.exatask.platform.jpa.changelogs;
...
public abstract class JpaChangelog extends BaseJavaMigration {

  protected static final AppLogger LOGGER = AppLogManager.getLogger();

  private AppDigest appDigest;

  protected JpaChangelog() {
  ...
  public Integer getChecksum() {
    ...
    try (
        InputStream inputStream = clazz.getClassLoader().getResource(clazzName).openStream();
