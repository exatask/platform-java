...
import com.exatask.platform.oracle.constants.Defaults;
import com.exatask.platform.oracle.exceptions.InvalidIdentifierException;
import com.exatask.platform.oracle.exceptions.InvalidOperationException;
import com.exatask.platform.oracle.filters.FilterElement;
import com.exatask.platform.oracle.joins.JoinElement;
import com.exatask.platform.oracle.replicas.ReplicaDataSource;
import com.exatask.platform.oracle.sorts.SortElement;
import com.exatask.platform.oracle.updates.UpdateElement;
import com.exatask.platform.oracle.updates.UpdateOperation;
...
public class AppOracleRepositoryImpl<T, ID extends Serializable> extends SimpleJpaRepository<T, ID> implements AppOracleRepository<T, ID> {
