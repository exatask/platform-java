...
import com.exatask.platform.postgresql.constants.Defaults;
import com.exatask.platform.postgresql.exceptions.InvalidIdentifierException;
...
public class AppPostgresqlRepositoryImpl<T, ID extends Serializable> extends SimpleJpaRepository<T, ID> implements AppPostgresqlRepository<T, ID> {
